...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    const t1 = setTimeout(() => setLoaderOut(true), 1300);
    const t2 = setTimeout(() => {
  ...
  useEffect(() => {
    ...
    const onLeave = (e) => {
      ...
      card.style.transition =
        "transform 0.5s cubic-bezier(0.4,0,0.2,1), box-shadow 0.3s, border-color 0.3s";
  ...
  // ── Magnetic Buttons ──────────────────────────────────────
  useEffect(() => {
    const btns = document.querySelectorAll(".btn-primary, .btn-cta-white, .nav-cta");
    ...
    const onMove = (e) => {
      ...
      btn.style.transform = `translate(${x}px, ${y}px) translateY(-2px) scale(1.02)`;
    };
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < 28; i++) {
      ...
      p.style.cssText = `left:${Math.random() * 100}%;bottom:${-10 + Math.random() * 10}%;width:${
        1 + Math.random() * 2
      }px;height:${1 + Math.random() * 2}px;opacity:${
        0.3 + Math.random() * 0.7
      };animation-duration:${8 + Math.random() * 16}s;animation-delay:${Math.random() * 12}s`;
      c.appendChild(p);
    }
    return () => {
      if (c) c.innerHTML = "";
  ...
  useEffect(() => {
    if (!document.getElementById("classora-fonts")) {
      ...
      link.rel = "stylesheet";
      link.href =
        "https://fonts.googleapis.com/css2?family=Cabinet+Grotesk:wght@400;500;700;800;900&family=Syne:wght@400;500;600;700;800&family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;1,9..40,300&display=swap";
  ...
  return (
    <>
      ...
      {/* ── PAGE LOADER ───────────────────────────── */}
      {loaderVisible && (
        <div className={`page-loader${loaderOut ? " page-loader-out" : ""}`}>
          <div className="loader-inner">
            <div className="loader-logo">
              <div className="loader-logo-bg" />
              <span className="loader-logo-text">Cl</span>
            </div>
            <p className="loader-brand">Classora</p>
            <div className="loader-track">
              <div className={`loader-fill${loaderOut ? " done" : ""}`} />
            </div>
            <p className="loader-sub">School OS</p>
          </div>
        </div>
      )}
      ...
      <section className="hero" id="home">
        ...
        <div className="hero-badge">
          <div className="hero-badge-dot">
            <svg viewBox="0 0 10 10">
              <path d="M5 1L6.8 3.6H9.5L7.3 5.4L8.1 8.1L5 6.3L1.9 8.1L2.7 5.4L.5 3.6H3.2Z" />
            </svg>
          </div>
        ...
        <p className="hero-sub">
          Classora brings together student management, AI-powered learning, attendance, analytics,
          and more — in one beautifully designed platform.
        </p>
        ...
        <div className="hero-mockup tilt-card reveal">
      ...
      <section id="features">
        <div className="features-header reveal">
          ...
          <p className="section-subtitle">
            From enrollment to graduation — Classora handles every aspect of school administration,
            beautifully.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Manage profiles, enrollment, grades, and progress reports for every student from one unified dashboard.",
              icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="#1a5cc8" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            },
            {
              delay: 2,
              title: "AI Learning",
              desc: "Personalized AI-driven recommendations help students improve performance and close learning gaps faster.",
              icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="#1a5cc8" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            },
            {
              delay: 3,
              title: "Exams & Grading",
              desc: "Schedule exams, auto-grade submissions, and generate detailed performance reports with a single click.",
              icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="#1a5cc8" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            },
            {
              ...
              desc: "Real-time digital attendance with automated alerts to parents when students are absent.",
              icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="#1a5cc8" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            },
            {
              ...
              desc: "Visual insights into school performance, trends, and KPIs — so you can make data-driven decisions.",
              icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="#1a5cc8" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                  <line x1="18" y1="20" x2="18" y2="10" />
                  <line x1="12" y1="20" x2="12" y2="4" />
                  <line x1="6" y1="20" x2="6" y2="14" />
                  <polyline points="18 4 12 10 6 14" />
                </svg>
              ),
            },
            {
              delay: 2,
              title: "Parent Portal",
              desc: "Give parents transparent, real-time access to their child's grades, attendance, and school announcements.",
              icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="#1a5cc8" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            },
            {
              ...
              desc: "Launch a professional school website with news, events, and admissions info — no coding required.",
              icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="#1a5cc8" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="10" />
            ...
            },
            {
              ...
              desc: "Automate invoicing, track payments, and send reminders — reduce late fees and improve cash flow.",
              icon: (
                <svg viewBox="0 0 24 24" fill="none" stroke="#1a5cc8" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div key={title} className={`feature-card tilt-card reveal reveal-delay-${delay}`}>
      ...
      <section id="steps">
        <div className="steps-header reveal" style={{ textAlign: "center" }}>
          ...
          <p className="section-subtitle" style={{ margin: "12px auto 0" }}>
            No technical expertise required. Set up your school management system in 3 easy steps.
          </p>
        </div>
        <div className="steps-grid">
          <div className="steps-connector">
            ...
            <div className="steps-connector-arrow">
              <svg viewBox="0 0 24 24" fill="none" stroke="#5599f5" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {[
            ...
            <div key={n} className={`step-card tilt-card reveal reveal-delay-${delay}`}>
      ...
      <section id="pricing">
        <div className="reveal" style={{ textAlign: "center" }}>
          ...
          <p className="section-subtitle" style={{ margin: "12px auto 0" }}>
            Flexible plans that grow with your institution. No hidden fees, cancel anytime.
          </p>
        ...
        <div className="plans-grid">
          ...
          <div className="plan-card reveal reveal-delay-1">
            ...
            <ul className="plan-features">
              {["Up to 200 students", "Attendance & grading", "Basic analytics", "Parent portal", "Email support"].map(
                (f) => (
                  <li key={f}>
                    {checkSvg} {f}
                  </li>
          ...
          <div className="plan-card featured reveal reveal-delay-2">
            ...
            <div className="plan-divider"></div>
            <ul className="plan-features">
              {["Up to 1,000 students", "AI Learning module", "Advanced analytics", "Fee management", "School website builder", "Priority support"].map(
                (f) => (
                  <li key={f}>
                    {checkSvg} {f}
                  </li>
          ...
          <div className="plan-card reveal reveal-delay-3">
            ...
            <div className="plan-divider"></div>
            <ul className="plan-features">
              {["Unlimited students", "All Pro features", "Custom integrations", "Dedicated account manager", "SLA & 24/7 support", "On-premise option"].map(
                (f) => (
                  <li key={f}>
                    {checkSvg} {f}
                  </li>
      ...
      <section id="about">
        <div className="reviews-header reveal">
          ...
          <h2 className="section-title">
            Loved by <span>50+ Institutions</span>
          </h2>
          <p className="section-subtitle">
            Hear from educators and administrators who run their schools on Classora every day.
          </p>
        </div>
        <div className="reviews-grid">
          {[
            ...
            <div key={name} className={`review-card tilt-card reveal reveal-delay-${delay}`}>
      ...
      <section id="contact">
        <div className="cta-content reveal">
          ...
          <p className="cta-sub">
            Join 50+ institutions already using Classora to save time, reduce admin work, and improve
            student outcomes.
          </p>
        ...
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <p className="footer-tagline">
              Modern school management software that helps educators focus on what matters — teaching.
            </p>
            <div className="footer-social">
              <a href="#" className="social-btn">
                <svg viewBox="0 0 24 24" fill="rgba(255,255,255,0.55)" stroke="none">
              ...
              <a href="#" className="social-btn">
                <svg viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.55)" strokeWidth="1.8" strokeLinecap="round">
